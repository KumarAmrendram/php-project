    ...
    <section class="banner">
        ...
        <div class="card-body">
            ...
            <!-- <div class="card mx-5 my -3" style="width: 15rem ;">
                <img src="https://source.unsplash.com/300x300/?coding,programming" class="card-img-top" alt="...">
                <div class="card-body">
            ...
            <div class="card mx-5 my -3" style="width: 15rem;">
                <img src="https://source.unsplash.com/300x300/?coding,computer" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title">Card title</h5>
                    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the
                        card's content.</p>
